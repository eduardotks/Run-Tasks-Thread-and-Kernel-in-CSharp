...
namespace SistemaWeb.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(SistemaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Rg,Fone")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Rg,Fone")] Funcionarios funcionarios)
        {
